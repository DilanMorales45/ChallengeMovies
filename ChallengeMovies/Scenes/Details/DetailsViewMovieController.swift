//
//  DetailsViewMovieController.swift
//  ChallengeMovies
//
...
class DetailsViewMovieController: UIViewController {
...
extension DetailsViewMovieController {
    class func buildWith(_ movie: commonDetails) -> DetailsViewMovieController {
        ...
        let controller = DetailsViewMovieController(detailView: view, movie: movie, navigationStyle: navStyle, service: service, favoriteService: FavoriteMovieService(repository: FavoriteMoviesDataRepository()))
        return controller
    }
}
